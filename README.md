...
<table width="100%">
	<tr>
		...
		<td width="50%" valign="top">
			...
			<p>The metrics workflow in <a href=".github/workflows/metrics.yml">.github/workflows/metrics.yml</a> keeps the additional metrics assets in sync on a schedule.</p>
		</td>
	</tr>
</table>
